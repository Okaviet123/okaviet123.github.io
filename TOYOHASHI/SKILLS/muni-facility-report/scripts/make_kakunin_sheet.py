...
CONFIG = {
    "city_name": "〇〇市",
    "report_title": "「〇〇市の公共施設 — これから30年のお金の地図」",
    "publish_date": "20XX年X月X日（X）",
    # 資料一覧: 記号, 正式名, 使うページ, (入手元URLは下のsource_urlsで別掲)
    "materials": [
        ("Ａ", "〇〇市公共施設等総合管理計画20XX-20XX", "31、34、52〜53"),
        ("Ｂ", "同 個別票「行政系施設」", "1〜2（市役所）"),
    ],
    "source_urls": [
        "資料Ａ: www.city.XXXX.lg.jp/XXXXX.htm",
        "Ｂ〜Ｆ: www.city.XXXX.lg.jp/XXXXX.htm",
    ],
    # 用語: (用語, 説明)
    "terms": [
